...
class ScreenReportCategory extends StatelessWidget {
  const ScreenReportCategory({super.key});
        ...
        child: ListView(
          children: [
            ...
            CommonOptionButtonWidget(
                ...
                text: 'Count Winning Report'),
                 AppSpacing.ksizedBox10,
            CommonOptionButtonWidget(
                onPressed: () {
                   // RouteConstat.nextNamed(context, const ScreenSubWinningRepeort());
                },
                text: 'Deleted Numbers'),
                 AppSpacing.ksizedBox10,
            CommonOptionButtonWidget(
                onPressed: () {
                    //RouteConstat.nextNamed(context, const ScreenSubWinningRepeort());
                },
                text: 'Rejected Numbers'),
          ],
        ),
      ),
    );
